            ...
            $('#btnEdit').bind('click',
                    function () {
                        ...
                        if (row) {
                            ...
                            $('#Parent').combotree({
                                url: '/BasicInfo/TypeTreeCustomLoad/?exceptUnitId='+row.编码
                            });
            ...
            $('#btnDel').bind('click',
                    function () {
                        ...
                        $.messager.confirm('提示', '是否删除这些数据?', function (r) {
                                ...
                                $.ajax({
                                    type: "POST",
                                    url: "/BasicInfo/TelTypeCustomDelete/?id=" + row.编码,
                                    success: function (msg) {
                                        if (msg.IsSuccess) {
...
<body class="easyui-layout">
    <div region="center" style="padding: 5px" border="true">
        <table id="grid" class="easyui-datagrid" align="center" toolbar="#tb" url="/BasicInfo/LoadTelTypeCustom/"
    ...
    <div id="Edit" icon="icon-save" style="padding: 5px; display: none;">
        <form id="form" method="post" action="/BasicInfo/TelTypeCustomSave/" enctype="application/x-www-form-urlencoded">
        <table style="margin-top:15px;">
            ...
            <tr>
                ...
                <td style="width: 15%; text-align: left">
                    <input id="Order" type="text" class="easyui-validatebox" name="entity.顺序号" required="true" onkeyup="this.value=this.value.replace(/[^\d]/g,'')"
