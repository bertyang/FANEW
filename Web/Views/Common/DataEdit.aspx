...
<body class="easyui-layout">
    <div region="center" border="true">
        ...
        <div region="center">
            <form id="form" method="post" action="/Common/DataSave/" enctype="application/x-www-form-urlencoded">
            <table width="100%">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="easyui-validatebox" required="true" name="entity.Value"
                            validtype="length[1,4]" value="<%= ((dynamic)this.ViewData["entity"]).Value %>"
                            style="border: 1px solid #8DB2E3; width: 146px; height: 18px" />
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="easyui-validatebox" required="true" name="entity.Remark"
                            validtype="length[1,4]" value="<%= ((dynamic)this.ViewData["entity"]).Remark %>"
                            style="border: 1px solid #8DB2E3; width: 146px; height: 18px" />
                    </td>
                </tr>
            </table>
