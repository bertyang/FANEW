        ...
        $(function () {
            ...
            $('#btnSearch').bind('click',
                    function () {
                        ...
                        $('#grid').datagrid('options').url = '/Common/DataLoad/?type=' + $('#type').combobox('getValue');
            ...
            $('#btnAdd').bind('click',
                    function () {
                        window.location.href = "/Common/DataEdit/";
                    }
                );
            ...
            $('#btnEdit').bind('click',
                    function () {
                        ...
                        if (row) {
                            window.location.href = "/Common/DataEdit/" + row.ID;
                        }
                        else {
...
<body class="easyui-layout">
    <div region="center" style="padding: 5px" border="true" > 
        <table id="grid" class="easyui-datagrid" align="center"  toolbar="#tb" url="/Common/DataLoad/"
