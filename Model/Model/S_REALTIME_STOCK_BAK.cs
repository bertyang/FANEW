...
{
	[Table(Name = "S_REALTIME_STOCK_BAK")]
	public class S_REALTIME_STOCK_BAK
	{
		private string _BackupMonth;
		/// <summary>
		/// BackupMonth
		/// </summary>
		[Column(IsPrimaryKey = true, Name = "BackupMonth", DbType = "nvarchar(20)", Storage = "_BackupMonth")]
		public string BackupMonth
		{
			get { return _BackupMonth; }
			set { _BackupMonth = value; }
		}
