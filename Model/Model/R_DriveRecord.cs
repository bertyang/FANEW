...
{
	[Table(Name = "R_DriveRecord")]
	public class R_DriveRecord
	{
		private int _ID;
		/// <summary>
		/// ID
		...
		/// Condition
		/// </summary>
		[Column(Name = "Condition", DbType = "varchar(100)", Storage = "_Condition", UpdateCheck = UpdateCheck.Never)]
		...
		/// BillNum
		/// </summary>
		[Column(Name = "BillNum", DbType = "varchar(20)", Storage = "_BillNum", UpdateCheck = UpdateCheck.Never)]
