...
{
	[Table(Name = "S_BILL_TRANSFER")]
	public class S_BILL_TRANSFER
	{
		...
		private int _InStoreHouseID;
		/// <summary>
		/// InStoreHouseID
		/// </summary>
		[Column(Name = "InStoreHouseID", DbType = "int", Storage = "_InStoreHouseID", UpdateCheck = UpdateCheck.Never)]
		public int InStoreHouseID
		{
			get { return _InStoreHouseID; }
			set { _InStoreHouseID = value; }
		}
		private int _OutStoreHouseID;
		/// <summary>
		/// OutStoreHouseID
		/// </summary>
		[Column(Name = "OutStoreHouseID", DbType = "int", Storage = "_OutStoreHouseID", UpdateCheck = UpdateCheck.Never)]
