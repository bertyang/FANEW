...
namespace Anchor.FA.BLL.WorkFlow
{
    ...
    /// 流程实例类
    /// </summary>
    public class FlowInstance : Instance 
    {
        #region 属性
        ...
        public void Create(int flowId,int flowNo,int applyerId, string digest)
        {
            ...
            m_FlowInstanceId = prikey.getIntPrimaryKey("F_INST_FLOW");
        ...
        {
            FlowAction flowAction = new FlowAction(this.FlowDefine.IsInner, this.FlowDefine.ID);
